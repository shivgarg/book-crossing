...
$query="select tid,price,title,isbn,author,firstname,secondname,modeofpayment from users,books,transactions,booksandusers where id1=".$id." and transactions.bookid=booksandusers.bookid and id1=booksandusers.userid and id2=users.userid and  transactions.bookid=books.bookid;";
