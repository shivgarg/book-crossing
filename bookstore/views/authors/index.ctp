<div class="authors index">
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $author['Author']['firstname']; ?>&nbsp;</td>
		<td><?php echo $author['Author']['lastname']; ?>&nbsp;</td>
		<td><?php echo $author['Author']['title']; ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $author['Author']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $author['Author']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
