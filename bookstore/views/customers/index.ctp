<div class="customers index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('discounts offered');?></th>
			<th><?php echo $this->Paginator->sort('amounts paid');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $customer['Customer']['adress']; ?>&nbsp;</td>
		<td><?php 
			$amt_discount=0;
			$amt_paid = 0;
			foreach($customer['Cart'] as $customerCart) {
				$amt_discount += $customerCart['discountedamount'];
				$amt_paid += $customerCart['amount'];
			}
			echo $amt_discount; 
		    ?>&nbsp;</td>
